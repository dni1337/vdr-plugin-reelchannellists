#
# Makefile for reelchannellist plugin
#
...
OBJS = $(PLUGIN).o menu.o menuitem.o channelListFilter.o tools.o favourites.o \
	activelist.o MenuCISlot.o setup.o MenuMoveChannels.o
...
$(I18Npot): $(wildcard *.c) menu.h menuitem.h
